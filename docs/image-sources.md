...
| `maya-studio-statement.webp` | Leaf shadows through tactile linen curtains — 强 任 (@rendy) | [Photo](https://unsplash.com/photos/light-filtering-through-hanging-linen-curtains-outdoors-81hLedo7pjk) · [License](https://unsplash.com/license) | Linen is used only as the full-width statement background; it is not presented as the actual office. |
| `maya-studio-bridge.webp` | Open window with sheer curtains and natural light — Jonathan Borba | [Photo](https://www.pexels.com/photo/opened-white-window-with-sheer-curtain-3255244/) · [License](https://www.pexels.com/license/) | A real window, natural light, and soft curtains open the ways-of-working section in the bridge; not a photograph of the practice. |
| `maya-studio-closing.webp` | Ceramic cup and saucer in window light — Lara Farber | [Photo](https://www.pexels.com/photo/cup-in-sunlight-and-shadow-20013047/) · [License](https://www.pexels.com/license/) | The smaller closing photograph shows a ceramic detail in window light without another landscape or additional practice claim. |
| `maya-studio-hero-detail.webp` | Houseplant leaf shadows on a soft beige wall — Karola G | [Photo](https://www.pexels.com/photo/shadow-of-home-plant-on-wall-4207776/) · [License](https://www.pexels.com/license/) | A small, calm daylight detail beside the hero's office photograph; atmospheric imagery, not the practice. |
| `maya-studio-begin.webp` | Brick path curving through a shaded green garden — Magda Ehlers | [Photo](https://www.pexels.com/photo/serene-pathway-through-a-lush-green-garden-34396586/) · [License](https://www.pexels.com/license/) | The larger closing photograph suggests a first step forward beside the invitation to begin; not presented as Maya's location or view. |
