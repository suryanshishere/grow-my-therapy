...
function Brand({ theme, footer = false }: { theme: Theme; footer?: boolean }) {
  return theme === "maya" ? <Link href="/" className={`maya-brand ${footer ? "maya-brand--footer" : ""}`} aria-label="Dr. Maya Reynolds home">
    ...
    <span className="brand-caption">Adult therapy · Santa Monica</span>
      ...
      <footer className="practice-footer">
        <div className="footer-grid">
          <div className="footer-brand-column"><Brand theme={theme} footer />
            <p>{original ? "We want to make getting started simple. You’re welcome to come into our office in Newbury Park or schedule virtual appointments from anywhere in CA—whatever works best for you." : "A grounded, collaborative approach to anxiety, trauma, and burnout. Space to understand yourself more deeply."}</p>
